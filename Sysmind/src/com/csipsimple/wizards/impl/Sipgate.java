...
import com.sysmind.home.LoginPage;
...
//            accountServer.setText("sipgate.de");
        	accountServer.setText(LoginPage.menuItems.get(0).get(LoginPage.KEY_AsteriskIP));
        }
        
//        accountUsername.setText(LoginPage.menuItems.get(0).get(LoginPage.KEY_Extension));
//		accountPassword.setText(LoginPage.menuItems.get(0).get(LoginPage.KEY_ExtPass));	
