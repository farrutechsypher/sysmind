...
public class Employee_Profile_Conf_Page  extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.employee_profile_conf_page);
		emplProfileListview=(ListView)findViewById(R.id.empl_conf_listview);
		empl_profpg_empimageview=(ImageView)findViewById(R.id.empl_conf_empimageview);
		empPrflButton1=(Button)findViewById(R.id.empl_conf_connect);		
		empl_profpg_logout_btn=(Button)findViewById(R.id.empl_conf_logout_btn);
//		empPrflAddGroupButton=(Button)findViewById(R.id.empl_profpg_addgroup);
		empPrflButton4=(Button)findViewById(R.id.empl_conf_email);
		empPrflShowResumeButton=(Button)findViewById(R.id.empl_conf_resume);
...
//		userExt = in.getStringExtra("UserExtension");
		if(selectedMenuType.equalsIgnoreCase("addGroup")){
		userName= LoginPage.sh_Pref.getString("UserName", null);
		userExt= LoginPage.sh_Pref.getString("joinUser", null);
...
//			Toast.makeText(getApplicationContext(), "add user extension is**"+userExt,Toast.LENGTH_LONG).show();	
		...
		empPrflTextview = (TextView)findViewById(R.id.empl_conf_textview);
		...
		ListAdapter adapter = new SimpleAdapter(this, menuItems,
				R.layout.empl_profconfpg_customized_layout,
				new String[] { KEY_PROFESSION, KEY_LOCATIONDATA}, new int[] {
				R.id.emp_prof_conf_details_textView1, R.id.emp_prof_conf_details_textView2});
		...
		empPrflButton1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String uri2 = "confrenceRequestSysmind?";
				String finalUrl = uri + uri2;
 				XMLParser parser = new XMLParser();
				parser.params.add(new BasicNameValuePair("confbridgeExtension", LoginPage.myExtension));
				parser.params.add(new BasicNameValuePair("joinUser", userExt));			
//				Toast.makeText(getApplicationContext(), "Welcum to url=" + finalUrl,
//						Toast.LENGTH_LONG).show();
//				Toast.makeText(getApplicationContext(), "Welcum to positionuserr=" + userExt,
//						Toast.LENGTH_LONG).show();
				 	
				String xml = parser.getXmlFromUrl(finalUrl);
				in = new Intent(getApplicationContext(), com.sysmind.home.Employee_Profile_Conf_Page.class);
	...
	public void onBackPressed()
	{
	    if(selectedMenuType.equalsIgnoreCase("addGroup")){
	    	 Intent intent = new Intent(Intent.ACTION_MAIN);
		    	intent = new Intent(Employee_Profile_Conf_Page.this, UserInGroupConf.class);
		        startActivity(intent);
	    	
	    }else if(selectedMenuType.equalsIgnoreCase("adduser")){
	    	Intent intent = new Intent(Intent.ACTION_MAIN);
	    	intent = new Intent(Employee_Profile_Conf_Page.this, Adduser.class);
	        startActivity(intent);
	    
	    }	else{
	    	
	    	Intent intent = new Intent(Intent.ACTION_MAIN);
	    	intent = new Intent(Employee_Profile_Conf_Page.this, Option_Page.class);
	        startActivity(intent);
